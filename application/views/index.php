...
<section class="finance_area">
    <div class="container">
        <div class="finance_inner row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="finance_item">
                    <div data-aos="fade-right" data-aos-duration="2000" class="media">
                        <div class="d-flex">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="finance_item">
                    <div data-aos="fade-right" data-aos-duration="2200" class="media">
                        <div class="d-flex">
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                <div class="main_title">
                    <h2 data-aos="fade-up" data-aos-duration="2000">Learnify Education Dibuat Untuk Meningkatkan Kualitas Pembelajaran Di Indonesia</h2>
                </div>
            </div>
        </div>
    </div>
