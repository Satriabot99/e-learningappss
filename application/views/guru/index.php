...
<head>
	...
	<script src="<?= base_url('assets') ?>/assets/vendors/custom/components/vendors/sweetalert2/init.js"></script>
		...
		<div class="main-wrapper">
					...
					<ul class="sidebar-menu">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a class="nav-link" href="<?= base_url('guru/data_tugas') ?>">Data Tugas Bimbel</a>
								</li>
							</ul>
						</li>
				</aside>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-12">
							<div class="card card-statistic-1">
								...
								<div class="card-wrap">
									...
									<div class="card-body">
										<?php echo $this->db->count_all('bimbel'); ?>
									</div>
								</div>
							</div>
						</div>
			...
			<footer class="main-footer">
				<div class="text-right">
					Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a> | Copyright &copy; 2020 <div class="bullet"></div><a href="https://github.com/syauqi"> Vera Kristina</a>
